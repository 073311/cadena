...
class Versions
{
    ...
    public static function changelog()
    {
        ...
        $url = 'https://api.github.com/repos/Ovds/Ovds/releases';
    ...
    public static function all($modules = null)
    {
        return Cache::remember('versions', Date::now()->addHours(6), function () use ($modules) {
            ...
            // Check core first
            $url = 'core/version/' . $info['Ovds'] . '/' . $info['php'] . '/' . $info['mysql'] . '/' . $info['companies'];
            ...
            foreach ($modules as $module) {
                ...
                if (! $module instanceof \Ovds\Module\Module) {
                    continue;
                }
            ...
            $versions['core'] = static::getLatestVersion($url, $info['Ovds']);
            ...
            foreach ($modules as $module) {
                ...
                $url = 'apps/' . $alias . '/version/' . $version . '/' . $info['Ovds'];
